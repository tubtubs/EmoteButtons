...
/script PickupInventoryItem(16);
/run ReplaceEnchant();]], type=2, tooltip="Rough Sharpening Stone", image="INV_Stone_SharpeningStone_01"},
{action=[[/use Minor Wizard Oil
/script PickupInventoryItem(16);
/run ReplaceEnchant();]], type=2, tooltip="Minor Wizard Oil", image="INV_Potion_100"},
{action=[[/use Rough Weightstone
/script PickupInventoryItem(16);
/run ReplaceEnchant();]], type=2, tooltip="Rough Weightstone", image="INV_Stone_SharpeningStone_02"}
},
["Taunts"]={
