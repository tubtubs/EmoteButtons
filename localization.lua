...
EMOTEBUTTONS_SE = {
	["Main"] = {
		...
		{action="/laugh", type=EBACTTYPE_EMOTE,tooltip="Laugh"},
		{action="/hi", type=EBACTTYPE_EMOTE,tooltip="Greet"},
	...
	["Deck 1"] = { {action="/thank",type=EBACTTYPE_EMOTE, tooltip="Thank"},
		{action="/welcome", type=EBACTTYPE_EMOTE,tooltip="Welcome"},
	...
	["Deck 8"] = { {action="/played", EBACTTYPE_SLASHCMD,tooltip="Show played time"},
		...
		{action="/sit", type=EBACTTYPE_EMOTE,tooltip="TEST"},
		{action="Deck 9", type=EBACTTYPE_DECK,tooltip="Deck 9"} },
	["Deck 9"] = { {action="/played",EBACTTYPE_SLASHCMD, tooltip="yed time"},
		{action="/lol", type=EBACTTYPE_EMOTE,tooltip="Said info"},
